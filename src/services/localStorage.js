(() => {
    if (typeof process.env.REACT_APP_LS_ACCESS_TOKEN === 'undefined') {
        console.warn('Variable REACT_APP_LS_ACCESS_TOKEN not defined in environment file');
    }
    if (typeof process.env.REACT_APP_LS_REFRESH_TOKEN === 'undefined') {
        console.warn('Variable REACT_APP_LS_REFRESH_TOKEN not defined in environment file');
    }
})();
